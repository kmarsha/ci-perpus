      ...
      foreach ($peminjams as $peminjam) {
        ?>
          <tr>
            ...
            <td><?= $peminjam->judul_buku ?> (<?= $peminjam->penulis ?>)</td>
            ...
            <td class="row justify-content-around">
              ...
              <button class="btn btn-danger" onclick="return (confirm('Yakin Hapus Data Peminjam <?= $peminjam->nama_siswa ?> (<?= $peminjam->judul_buku ?>) ?')) ? deletePeminjam('<?= $peminjam->peminjam_id ?>') : '' ">Hapus</button>
            </td>
          </tr>
        <?php
      }
